...
export const projects = [
  {
    ...
    cover: { id: "media-signal-cover", type: "image", src: "/images/project-signal.svg", alt: "Composição editorial laranja do projeto Signal Commerce", width: 1600, height: 1000 }, media: [],
  ...
  },
  {
    ...
    cover: { id: "media-atlas-cover", type: "image", src: "/images/project-atlas.svg", alt: "Composição editorial verde do projeto Atlas Operations", width: 1600, height: 1000 }, media: [],
  ...
  },
  {
    ...
    cover: { id: "media-orbit-cover", type: "image", src: "/images/project-orbit.svg", alt: "Composição editorial azul do projeto Orbit Intelligence", width: 1600, height: 1000 }, media: [],
